...
for i, ques in enumerate(all_ques):
    ...
    for multiplier in range(0,4):
        ...
        for i in range(5):
            output = model.model.generate(prompt_tokens, temperature=0.6, max_new_tokens=3000)
...
import json
with open('./data/r1/overthink_qwen/results/results_qwen_ques_gsm_top20_add_gsm_template_temp0.6.json', 'w') as json_file:
